...
# Generated on: Thu Dec 14 18:03:59 WET 2023 (Thu Dec 14 18:03:59 UTC 2023)
...
set_log_file fv/b01/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/b01 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  b01.v
elaborate_design -golden -root {b01} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/b01/fv_map.v.gz
elaborate_design -revised -root {b01}
...
#add_name_alias fv/b01/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/b01/rtl_to_fv_map.log
}
