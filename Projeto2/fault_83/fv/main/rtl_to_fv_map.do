...
# Generated on: Sun Jan 07 15:30:30 WET 2024 (Sun Jan 07 15:30:30 UTC 2024)
...
set_log_file fv/main/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/main -revised fv_map
...
read_library -liberty -both /opt/ic_tools/pdk/ams_c35_410/liberty/c35_3.3V/c35_CORELIB_TYP.lib /opt/ic_tools/pdk/ams_c35_410/liberty/c35_3.3V/c35_CORELIB_TYP.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  circuito_scan_syn.v main.v MISR.v Bist_Control.v LFSR.v Comparador.v
elaborate_design -golden -root {main} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/main/fv_map.v.gz
elaborate_design -revised -root {main}
...
#add_name_alias fv/main/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/main/rtl_to_fv_map.log
}
