...
# Generated on: Sat Jan 06 19:48:36 WET 2024 (Sat Jan 06 19:48:36 UTC 2024)
...
set_log_file fv/circuito12/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/circuito12 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  circuito12.v
elaborate_design -golden -root {circuito12} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/circuito12/fv_map.v.gz
elaborate_design -revised -root {circuito12}
...
#add_name_alias fv/circuito12/fv_map.singlebit.original_name.alias.json.gz -revised
...
#---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
#  1      scan_en                        shift_enable     true       false       port        none                       true                  true          auto       
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/circuito12/rtl_to_fv_map.log
}
